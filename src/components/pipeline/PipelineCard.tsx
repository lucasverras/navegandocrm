...
export function PipelineCard({
  ...
  return (
    <div
      ...
      className={cn(
        "lift group flex cursor-grab select-none touch-none flex-col gap-1 rounded-lg border border-border-subtle bg-surface p-2 text-sm shadow-[0_1px_2px_rgba(0,0,0,0.06),0_1px_4px_rgba(0,0,0,0.04)] active:cursor-grabbing",
