...
| Pipeline: sequential→parallel | −100-200ms | Messages query in Promise.all (4→4 parallel, 0 sequential) |
...
| Queries per /pipeline load | 8 (4+4 sequential) | 8 (4 parallel) | Zero waterfall |
